...
public class Arxeia_mo implements Serializable {
	public static void grapsimo_Room() {
		try {

			ObjectOutputStream out = new ObjectOutputStream(
					new FileOutputStream("C:\\Users\\mant6\\eclipse-workspace\\Mo\\room.ser"));
	...
	public static void parsimo_Room() {
		try {
			FileInputStream fis = new FileInputStream("C:\\Users\\mant6\\eclipse-workspace\\Mo\\room.ser");
	...
	public static void grapsimo_Booking() {
		try {
			...
			ObjectOutputStream out = new ObjectOutputStream(
					new FileOutputStream("C:\\Users\\mant6\\eclipse-workspace\\Mo\\bookings.ser"));
	...
	public static void parsimo_Booking() {
		try {
			FileInputStream fis = new FileInputStream("C:\\Users\\mant6\\eclipse-workspace\\Mo\\bookings.ser");
			ObjectInputStream ois = new ObjectInputStream(fis);
