 ...
 * of every month. *** WON'T be used at the presentation of the project because
 * of the difficulties at checking.
 * 
...
public class monthThread implements Runnable {
	 ...
	 * be done at the start of every month after every execution of these actions
	 * sleeps till the 1st day of the next month
	 */
	public void run() {
		while (true) {
			try {
