 ...
 * 
 *         This class works as a play maker of the whole Reporting and finance
 *         department. Its only purpose is to call methods from other classes to
 *         display intel. After calling Menu(): By pressing 1 the class displays
 *         HR analytics by pressing 2 connects to finance menu
 *         (ReportingFinance.java) by pressing 3 displays customers analytics
 *         and by pressing 0 returns to the home page.
 *
 */
...
public class Reporting {
	...
	static void loadobjects() {
		...
		// (onoma , epitheto , satisfaction ( 0 - 5) , payment , familyalone (0 - 3) ,
		// daysofstey , reasonoftravel ( 0 - 4) , email , know)
		...
		ReportingClients c3 = new ReportingClients("Dimitris", "gianakopoulos", 5, 210, 3, 5, 0, "dpg7000@gmail.com",
				2);
