...
public class Shift {
	...
	public int[][] arr_Dep_Times_int(String day_schedule) { // uses a String
															// input of a daily
															// timetable
	...
	public Calendar getNextMonday() { // returns when the next monday is (Calendar type)
	...
	public Calendar[][] arr_Dep_Times_Cal(int[][] arrH_arrM_depH_depM, Calendar cal, int daysFromMonday) { // cal when
																											// the next
																											// monday
																											// is, uses
																											// the list
	...
	public Calendar[] connect_Arr_Dep(Calendar[][] cal) { // connects the Arrival and Departure times at the right order of the array that the arr_Dep_Times_Cal created
	...
	public Calendar[] week_Schedule(Calendar[][] calSchedule) {// connects the indexes of an Array Calendar[][] at an
																// Array Calendar[]
	...
	public boolean Check_week_Schedule(Calendar[] fullWeek) {// checks that there are no back to back arrivals
	...
	public Calendar[][] connectsAllMethods(String[] strSchedule) {
